...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2019 at 10:54 AM
...
INSERT INTO `blog_posts` (`email`, `post_id`, `title`, `author`, `content`, `intro`, `date`, `category`) VALUES
...
INSERT INTO `categories` (`post_id`, `email`, `category`) VALUES
(1, 'laurawhite@gmail.com', 'PHP'),
(2, 'tiffany.domena@yahoo.com', 'PHP'),
(3, 'laurawhite@gmail.com', 'Fight Spam');
...
--
ALTER TABLE `blog_posts`
  ADD CONSTRAINT `blog_posts_ibfk_1` FOREIGN KEY (`email`) REFERENCES `user_info` (`email`);

--
-- Constraints for table `categories`
--
ALTER TABLE `categories`
  ADD CONSTRAINT `categories_ibfk_1` FOREIGN KEY (`email`) REFERENCES `user_info` (`email`);
